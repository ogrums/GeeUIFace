...
public class SystemUtil {
    ...
    private static final String TITLE_TOUCH_STATUS = "persist.sys.title.touch";
    ...
    public static final String TITLE_TOUCH_STATUS_OPENED = "open";
    public static final String TITLE_TOUCH_STATUS_CLOSED = "close";
    ...
    public static void openTitleTouchStatus() {
        set(TITLE_TOUCH_STATUS, TITLE_TOUCH_STATUS_OPENED);
    }

    public static void closeTitleTouchStatus() {
        set(TITLE_TOUCH_STATUS, TITLE_TOUCH_STATUS_CLOSED);
    }
    public static boolean getTitleTouchStatus() {
        String status = get(TITLE_TOUCH_STATUS, TITLE_TOUCH_STATUS_OPENED);
        if (status.equals(TITLE_TOUCH_STATUS_OPENED)) {
            return true;
        }
        return false;
    }
