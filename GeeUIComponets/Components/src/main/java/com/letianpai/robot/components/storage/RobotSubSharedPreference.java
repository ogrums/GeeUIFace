 ...
 * @author liujunbin
 */
public class RobotSubSharedPreference {
    ...
    public static final String SHARE_PREFERENCE_NAME = "RobotSubConfig";
    ...
    public RobotSubSharedPreference(Context context, String fileName, String action) {
