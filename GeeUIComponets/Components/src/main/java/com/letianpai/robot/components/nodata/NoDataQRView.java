 ...
 * @author liujunbin
 */
public class NoDataQRView extends RelativeLayout {
    ...
    public NoDataQRView(Context context) {
        super(context);
        init(context);
    }

    public NoDataQRView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public NoDataQRView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public NoDataQRView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
