 ...
 * @author liujunbin
 */
public class RobotSharedPreference {
    ...
    public static String SHARE_PREFERENCE_NAME = "";
    ...
    public RobotSharedPreference(Context context, String fileName, String action) {
