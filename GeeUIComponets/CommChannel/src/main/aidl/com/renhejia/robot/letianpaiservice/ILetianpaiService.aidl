...
interface ILetianpaiService {
    ...
    void setIdentifyCmd(String command, String data);

    void registerIdentifyCmdCallback(LtpIdentifyCmdCallback identifyCmdCallback);

    void unregisterIdentifyCmdCallback(LtpIdentifyCmdCallback identifyCmdCallback);


    void setBleCmd(String command, String data,boolean isNeedResponse);

    void registerBleCmdCallback(LtpBleCallback bleCallback);

    void unregisterBleCmdCallback(LtpBleCallback bleCallback);


    void setBleResponse(String command, String data);

    void registerBleResponseCallback(LtpBleResponseCallback bleResponseCallback);

    void unregisterBleResponseCmdCallback(LtpBleResponseCallback bleResponseCallback);
