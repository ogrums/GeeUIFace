...
| ExoPlayer 2.17 | **Media3 1.5.1** (GeeUIFace) |
...
Le chemin des sous-modules dans `settings.gradle` pointait vers `GeeUIComponents/`
(mauvais nom). Corrigé vers `GeeUIComponets/`.

Après clone : `git submodule update --init`.
