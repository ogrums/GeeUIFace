...
//            if (index >= 0 && index < gestureList.size() - 1) {
        ...
        } else if (gesture.equals(GestureConsts.GESTURE_CLOSE_CLOCK)) {
        ...
        } else if (gesture.equals(GestureConsts.GESTURE_WAKEUP)) {
            return GestureCenter.getWakeupGesture();

        } else if (gesture.equals(GestureConsts.GESTURE_HAND_RECOGNITION)) {
            return null;
//            return GestureCenter.getHandGestureWithID("0");

        } else if (gesture.equals(GestureConsts.GESTURE_MOTION_SAD)) {
            return GestureCenter.getSadGesture();

        } else if (gesture.equals(GestureConsts.GESTURE_MOTION_HAPPY)) {
            return GestureCenter.getHappyGesture();
