...
//    public final static String  COMMAND_VALUE_SOUND_HAPPY = "happy";
     ...
     * 寻人
     */
    public final static String  COMMAND_VALUE_SOUND_FOUND_PEOPLE = "found_people";
    /**
     * 寻人
     */
    public final static String  COMMAND_VALUE_SOUND_HELLO = "hello";

    /**
     *  疑惑
     */
    public final static String  COMMAND_VALUE_SOUND_PUZZLE = "puzzle";
    /**
     *  疑惑
     */
    public final static String  COMMAND_VALUE_SOUND_PUZZLE2 = "puzzle2";

    /**
     * 吃惊
     */
    public final static String  COMMAND_VALUE_SOUND_AMAZED = "amazed1";

    /**
     *
     */
    public final static String  COMMAND_VALUE_SOUND_AMAZED2 = "amazed2";
     ...
     * 害羞
     */
    public final static String  COMMAND_VALUE_SOUND_BASHFUL = "bashful";

    /**
     * 呼吸
     */
    public final static String  COMMAND_VALUE_SOUND_BREATHE = "breathe";
...
//    public final static String  COMMAND_VALUE_SOUND_COMFORTABLE = "comfortable";
     ...
     * 不合意的
     */
    public final static String  COMMAND_VALUE_SOUND_DISAGREE = "disagreeable";
...
//    public final static String  COMMAND_VALUE_SOUND_FEAR = "fear";
     ...
     * 慌乱的
     */
    public final static String  COMMAND_VALUE_SOUND_FLURRIED = "flurried";
     ...
     * 主形象
     */
    public final static String  COMMAND_VALUE_SOUND_MIANIMAGE = "mainimage";

    /**
     * 偷窥
     */
    public final static String  COMMAND_VALUE_SOUND_PEEP = "peep";

    /**
     * 响应
     */
    public final static String  COMMAND_VALUE_SOUND_RESPONSE = "response";
...
//    public final static String  COMMAND_VALUE_SOUND_TIRED = "tired";
     ...
     * 非常慢
     */
    public final static String  COMMAND_VALUE_SOUND_VERY_TIRED = "very_tired";

    /**
     *
     */
    public final static String  COMMAND_VALUE_SOUND_WAKE_UP = "wake_up";

    /**
     *
     */
    public final static String  COMMAND_VALUE_SOUND_ = "wake_up";

    /**
     *
     */
    public final static String  COMMAND_FUNCTION_SHUTDOWN = "shut_down";


    /**
     *
     */
    public final static String  COMMAND_FUNCTION_BATTERY_LOW = "batlower";

    /**
     *
     */
    public final static String  COMMAND_FUNCTION_START_CHARGE = "startcharge";

    /**
     * 完成
     */
    public final static String  COMMAND_FUNCTION_FINISH = "finish";

    /**
     * 完成
     */
    public final static String  COMMAND_FUNCTION_STOP = "stop";
